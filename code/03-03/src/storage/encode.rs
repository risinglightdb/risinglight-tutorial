...
use super::{BlockBuilder, PlainPrimitiveBlockBuilder};
...
pub trait PrimitiveFixedWidthEncode: Copy + Clone + 'static + Send + Sync {
    ...
    type BlockBuilderType: BlockBuilder<Self::ArrayType>;
...
impl PrimitiveFixedWidthEncode for bool {
    ...
    type BlockBuilderType = PlainPrimitiveBlockBuilder<bool>;
...
impl PrimitiveFixedWidthEncode for i32 {
    ...
    type BlockBuilderType = PlainPrimitiveBlockBuilder<i32>;
...
impl PrimitiveFixedWidthEncode for f64 {
    ...
    type BlockBuilderType = PlainPrimitiveBlockBuilder<f64>;
